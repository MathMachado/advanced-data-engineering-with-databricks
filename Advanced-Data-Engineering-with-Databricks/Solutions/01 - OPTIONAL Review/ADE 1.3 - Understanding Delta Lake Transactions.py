...
# MAGIC %md
# MAGIC The transaction log directory is nested under the table directory and contains a log file for each transaction (alongside sum check files and other files used to manage consistency with cloud object storage).
